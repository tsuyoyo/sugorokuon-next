...
@kotlin.jvm.JvmName("-initializegetTimetableResponse")
public inline fun getTimetableResponse(block: com.tsuyogoro.sugorokuon.GetTimetableResponseKt.Dsl.() -> kotlin.Unit): com.tsuyogoro.sugorokuon.GetTimetableResponse =
  com.tsuyogoro.sugorokuon.GetTimetableResponseKt.Dsl._create(com.tsuyogoro.sugorokuon.GetTimetableResponse.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `tsuyogoro.sugorokuon.GetTimetableResponse`
 */
public object GetTimetableResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.tsuyogoro.sugorokuon.GetTimetableResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.tsuyogoro.sugorokuon.GetTimetableResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.tsuyogoro.sugorokuon.GetTimetableResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.tsuyogoro.sugorokuon.GetTimetableResponse.copy(block: `com.tsuyogoro.sugorokuon`.GetTimetableResponseKt.Dsl.() -> kotlin.Unit): com.tsuyogoro.sugorokuon.GetTimetableResponse =
  `com.tsuyogoro.sugorokuon`.GetTimetableResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
